...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cut.setGeometry(QtCore.QRect(790, 380, 311, 51))
        font = QtGui.QFont()
...
"")
        ...
        self.clear.setGeometry(QtCore.QRect(790, 440, 311, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
...
"background-color: rgb(118, 145, 161);")
        ...
        self.exit.setGeometry(QtCore.QRect(790, 500, 311, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
...
"background-color: rgb(255, 97, 97);")
        ...
        self.c_xs = QtWidgets.QLineEdit(self.centralwidget)
        self.c_xs.setGeometry(QtCore.QRect(1160, 90, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.c_xs.setFont(font)
        self.c_xs.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.c_xs.setObjectName("c_xs")
        self.c_ys = QtWidgets.QLineEdit(self.centralwidget)
        self.c_ys.setGeometry(QtCore.QRect(1300, 90, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.c_ys.setFont(font)
        self.c_ys.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.c_ys.setObjectName("c_ys")
        self.c_xe = QtWidgets.QLineEdit(self.centralwidget)
        self.c_xe.setGeometry(QtCore.QRect(1160, 160, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.c_xe.setFont(font)
        self.c_xe.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.c_xe.setObjectName("c_xe")
        self.c_ye = QtWidgets.QLineEdit(self.centralwidget)
        self.c_ye.setGeometry(QtCore.QRect(1300, 160, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.c_ye.setFont(font)
        self.c_ye.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.c_ye.setObjectName("c_ye")
...
"background-color: rgb(186, 255, 161);")
        ...
        self.label_6.setGeometry(QtCore.QRect(100, 600, 1081, 21))
        font = QtGui.QFont()
...
"color: rgb(0, 0, 0);")
        ...
        self.label_12.setGeometry(QtCore.QRect(100, 640, 1081, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setItalic(True)
        ...
        self.label_13.setGeometry(QtCore.QRect(100, 680, 1081, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setItalic(True)
        ...
        self.label_14.setGeometry(QtCore.QRect(100, 720, 1081, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setItalic(True)
        ...
        self.end_cutter.setGeometry(QtCore.QRect(790, 320, 311, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.end_cutter.setFont(font)
        self.end_cutter.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(85, 170, 127);")
        self.end_cutter.setObjectName("end_cutter")
        self.label_16 = QtWidgets.QLabel(self.centralwidget)
        self.label_16.setGeometry(QtCore.QRect(100, 760, 1331, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setItalic(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Грань отсекателя"))
        self.label_2.setText(_translate("MainWindow", "X (нач.)"))
        self.label_3.setText(_translate("MainWindow", "У (нач.)"))
        self.label_4.setText(_translate("MainWindow", "У (кон.)"))
        self.label_5.setText(_translate("MainWindow", "X (кон.)"))
        self.draw_cutter.setText(_translate("MainWindow", "Добавить грань"))
        self.label_6.setText(_translate("MainWindow", " Зажмите Shift для ввода граней отсекателя с помощью мыши."))
        ...
        self.end_cutter.setText(_translate("MainWindow", "Замкнуть границу отсекателя"))
        self.label_16.setText(_translate("MainWindow", " Зажмите Ctrl+P и кликните 2 раза мышкой, обозначив концы отрезка, для ввода отрезка, параллельного одной из границ отсекателя."))
