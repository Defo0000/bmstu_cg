...
"color: rgb(0, 0, 0);")
        ...
        self.label_15.setGeometry(QtCore.QRect(190, 780, 1081, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setItalic(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(_translate("MainWindow", " Кликните мышкой, обозначив конец отрезка, и затем нажмите ALT для привязки конца отрезка к границе."))
